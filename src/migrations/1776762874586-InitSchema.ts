...
export class InitSchema1776762874586 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_da2e1b29c48f82fa76b3dbb962" ON "chat_rooms" ("room_id", "type") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_34275c9a7ab25a6fc7749099db" ON "chat_messages" ("chat_room_id", "client_id") WHERE "client_id" IS NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_eb032fdf515347a034de2e8a8c" ON "chat_messages" ("chat_room_id", "created_at") `);
        await queryRunner.query(`CREATE TABLE "chat_reads" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "chat_room_id" uuid NOT NULL, "user_id" uuid NOT NULL, "last_read_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(), "last_read_id" uuid, CONSTRAINT "UQ_87c143e41258b8eaae0b84140e6" UNIQUE ("chat_room_id", "user_id"), CONSTRAINT "PK_e6ff4690c4391df4842a0622cbe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "photos" ADD CONSTRAINT "FK_7f7c4c84fa4db7bfca01038d13b" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "photos" ADD CONSTRAINT "FK_afc41ed8d80de3a64f9c958f76a" FOREIGN KEY ("uploader_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chat_rooms" ADD CONSTRAINT "FK_3f26d3daf7f285f061ba377339b" FOREIGN KEY ("room_id") REFERENCES "rooms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "chat_reads" ADD CONSTRAINT "FK_515dc76b03e77dbeed230b58989" FOREIGN KEY ("chat_room_id") REFERENCES "chat_rooms"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chat_reads" ADD CONSTRAINT "FK_e371b4cda152da0d3eafac5b1f1" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chat_reads" ADD CONSTRAINT "FK_22745374e39e413b35b72feedca" FOREIGN KEY ("last_read_id") REFERENCES "chat_messages"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "chat_reads" DROP CONSTRAINT "FK_22745374e39e413b35b72feedca"`);
        await queryRunner.query(`ALTER TABLE "chat_reads" DROP CONSTRAINT "FK_e371b4cda152da0d3eafac5b1f1"`);
        await queryRunner.query(`ALTER TABLE "chat_reads" DROP CONSTRAINT "FK_515dc76b03e77dbeed230b58989"`);
        ...
        await queryRunner.query(`ALTER TABLE "chat_rooms" DROP CONSTRAINT "FK_3f26d3daf7f285f061ba377339b"`);
        await queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT "FK_afc41ed8d80de3a64f9c958f76a"`);
        await queryRunner.query(`ALTER TABLE "photos" DROP CONSTRAINT "FK_7f7c4c84fa4db7bfca01038d13b"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_eb032fdf515347a034de2e8a8c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_34275c9a7ab25a6fc7749099db"`);
        await queryRunner.query(`DROP TABLE "chat_messages"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_da2e1b29c48f82fa76b3dbb962"`);
